...
class OptionsMenuKade extends MusicBeatState
{
	...
	var options:Array<OptionCategory> = [
		...
		new OptionCategory("BETADCIU", [
			...
			new UncacheCharacterSwitch("Uncache characters when they switch out. Reduces memory usage as you play the song but might lag a bit.")
			#end
		]),
