...
class FlxUINumericStepper extends FlxUIGroup implements IFlxUIWidget implements IFlxUIClickable implements IHasParams
{
	...
	//so that you can also use shift and alt on the steppers!

	private function _onPlus():Void
	{
		value += stepSize * (FlxG.keys.pressed.ALT ? 5 * (stepSize < 3 ? 10 : 1): (FlxG.keys.pressed.SHIFT ? 1 * (stepSize < 3 ? 10 : 1) : 1));
