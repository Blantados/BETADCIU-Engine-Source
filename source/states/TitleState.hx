...
class TitleState extends MusicBeatState
{
	...
	var titlestatebg:Null<FlxBackdrop>;
	...
	{
		persistentUpdate = true;
		FunkinSound.playMusic('freakyMenu', { startingVolume: !initialized ? 0 : 0.7, overrideExisting: true, persist: true });
	...
	override function update(elapsed:Float)
	{
		...
		var pressedEnter:Bool = (FlxG.keys.justPressed.ENTER || controls.ACCEPT) && !FlxG.keys.pressed.ALT;
		...
		if (initialized && !transitioning && skippedIntro)
		{
			...
			if(pressedEnter)
			{
				...
				FunkinSound.playOnce('confirmMenu', 0.7);
		...
		if(!closedState)
		{
			...
			switch (sickBeats)
			{
				...
				case 5:
					deleteCoolText();
				case 6:
					createCoolText(['BETADCIU Engine', 'by'], -40);
				case 8:
					addMoreText('Blantados', -40);
					ngSpr.visible = true;
				case 9:
					deleteCoolText();
					ngSpr.visible = false;
