...
class StoryMenuState extends MusicBeatState
{
	...
	function changeDifficulty(change:Int = 0):Void
	{
		...
		var newImage:FlxGraphic = Paths.returnGraphic('menudifficulties/' + Paths.formatToSongPath(diff));
	...
	function changeWeek(change:Int = 0):Void
	{
		...
		if(assetName == null || assetName.length < 1) {
			...
			bgSprite.loadGraphic(Paths.image(Paths.imageExists('menubackgrounds/menu_' + assetName) ? 'menubackgrounds/menu_' + assetName : 'menubackgrounds/menu_stage'));
		}
