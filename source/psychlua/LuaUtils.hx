...
class LuaUtils
{
	...
	public static function setVarInArray(instance:Dynamic, variable:String, value:Dynamic, allowMaps:Bool = false):Any
	{
		...
		if (value == "false") value = false; //stupid fix but whatever
	...
	public static function getPropertyLoop(split:Array<String>, ?getProperty:Bool=true, ?allowMaps:Bool = false, ?checkForTextsToo:Bool = true):Dynamic
	{
	...
	public static function getObjectDirectly(objectName:String, ?allowMaps:Bool = false):Dynamic
	{
		switch(objectName)
		{
			...
			default:
				if (objectName == 'dadGroup' || objectName == 'boyfriendGroup' || objectName == 'gfGroup'){ // update: i killed Groups.
