...
class CoolUtil
{
	public static function checkForUpdates(url:String = null):String {
		if (url == null || url.length == 0)
			url = "https://raw.githubusercontent.com/icaroleeb/BETADCIU-Engine-Source/Psych-Based/gitVersion.txt";
		var version:String = states.MainMenuState.betadciuVer.trim();
