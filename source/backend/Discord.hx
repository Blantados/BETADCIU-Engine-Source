...
class DiscordClient
{
	...
	public static function changePresence(details:String = 'In the Menus', ?state:String, ?smallImageKey:String, ?hasStartTimestamp:Bool, ?endTimestamp:Float, largeImageKey:String = 'icon')
	{
		...
		presence.largeImageKey = 'kaguya';
		presence.largeImageText = "Engine Version: " + states.MainMenuState.betadciuEngineVersion;
	...
	#if MODS_ALLOWED
	public static function loadModRPC() // i don't like this
	{
