 ...
 */
class ColorTweenCustom extends FlxTween
{
	public var color(default, null):FlxColor;

	var startColor:FlxColor;
	var endColor:FlxColor;
	public static var instance:ColorTweenCustom = null;
	 ...
	 */
	public function tween(Duration:Float, FromColor:FlxColor, ToColor:FlxColor, ?Sprite:FlxSprite):ColorTweenCustom
	{
